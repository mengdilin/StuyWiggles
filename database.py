...
def accept_request(postername,acceptername,request):
    ...
    prequest=request.append(poster["name"])
    arequest=request.append(accepter["name"])
    ...
    accepter["notification"]["accept"][postername].append(arequest)
    if len(poster["notification"]["accepted"][acceptername])>=7:
        poster["notification"]["accepted"][acceptername].pop(0)
    poster["notification"]["accepted"][acceptername].append(prequest)
